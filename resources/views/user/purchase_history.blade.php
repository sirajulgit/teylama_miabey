        ...
        <div class="container-fluid">
            ...
            <div class="account-tab mt-2">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-last-day-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-last-day" type="button" role="tab" aria-controls="pills-last-day"
                            aria-selected="false"> Last 7 days </button>
                    </li>

                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="one-month-tab" data-bs-toggle="pill" data-bs-target="#one-month"
                            type="button" role="tab" aria-controls="one-month" aria-selected="false"> Nearly 30 days
                        </button>
                    </li>
