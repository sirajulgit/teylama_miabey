                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">About US Banner Add</h3>

                            <div class="card-tools">
                                <a href="{{ route('cms_book_banner_list') }}" class="btn btn-primary">Back</a>
                            </div>
                        </div>
                        <!-- /.card-header -->

                        <form id="quickForm" action="{{ route('post_cms_book_banner_create') }}" method="POST"
                            ...
                            <div class="card-body row">
                                ...
                                <input type="hidden" name="type" value="book_page">
