                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select disabled class="form-control select2" style="width: 100%;" name="type">
                                        ...
                                        <option value="about_page"
                                            {{ $data['item']['type'] == 'about_page' ? 'selected' : '' }}>About Page
                                        </option>
                                        <option value="blog_page"
                                            {{ $data['item']['type'] == 'blog_page' ? 'selected' : '' }}>Blog Page</option>
                                        <option value="event_page"
                                            {{ $data['item']['type'] == 'event_page' ? 'selected' : '' }}>Event Page
                                        </option>
                                        <option value="gallery_page"
                                            {{ $data['item']['type'] == 'gallery_page' ? 'selected' : '' }}>Gallery Page
                                        </option>
                                        <option value="contact_page"
                                            {{ $data['item']['type'] == 'contact_page' ? 'selected' : '' }}>Contact Page
                                        </option>
                                    </select>
                                </div>
