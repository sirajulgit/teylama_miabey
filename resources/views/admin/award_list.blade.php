                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('award_create') }}" class="btn btn-primary">Add</a>
                            </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 8%" class="text-center">Award Status</th>
                                    ...
                                    @foreach ($data['items'] as $item)
                                        <tr>
                                            ...
                                            <td class="project-actions">
                                                <a class="btn btn-info btn-sm" href="{{ Route('award_edit', $item->id) }}">
