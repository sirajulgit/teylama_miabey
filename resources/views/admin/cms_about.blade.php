            ...
            <div class="row">
                ...
                <div class="col-lg-12 mb-5">
                    <div class="card">
                        ...
                        <form id="aboutForm" action="{{ route('post_cms_about') }}" method="POST"
                ...
                <div class="col-lg-12 mb-5">
                    <div class="card">
                        ...
                        <form id="what_we_do_form" action="{{ route('post_cms_about') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                ...
                <div class="col-lg-12 mb-5">
                    <div class="card">
                        ...
                        <form id="video_sectionForm" action="{{ route('post_cms_about') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                ...
                <div class="col-lg-12 mb-5">
                    <div class="card">
                        ...
                        <form id="info_sectionForm" action="{{ route('post_cms_about') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
