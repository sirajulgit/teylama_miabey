                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Cms News Events Banner Add</h3>

                            <div class="card-tools">
                                <a href="{{ route('cms_newsEvents_banner_list') }}" class="btn btn-primary">Back</a>
                            </div>
                        </div>
                        <!-- /.card-header -->

                        <form id="quickForm" action="{{ route('post_cms_newsEvents_banner_create') }}" method="POST"
                            ...
                            <div class="card-body row">
                                ...
                                <input type="hidden" name="type" value="newsEvents_page">
