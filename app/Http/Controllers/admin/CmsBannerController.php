...
class CmsBannerController extends Controller
{
    ...
    public function index()
    {
        ...
        $items = CmsBanner::where("status", 1)->get();
        ...
        return view("admin.cms_banner_list", ["data" => $data]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.cms_banner_create", ["data" => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view("admin.cms_banner_edit", ["data" => $data]);
    }
