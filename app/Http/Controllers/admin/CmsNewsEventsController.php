...
class CmsNewsEventsController extends Controller
{
    //
    ...
    public function index()
    {
        ...
        $data['activeSubMenu'] = 'cms_newsEvents_banner';

        $items = CmsBanner::where('type', 'newsEvents_page')->orderBy("id", "asc")->get();
        ...
        return view("admin.cms_newsEvents_banner_list", ["data" => $data]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.cms_newsEvents_banner_create", ["data" => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view("admin.cms_newsEvents_banner_edit", ["data" => $data]);
    }
