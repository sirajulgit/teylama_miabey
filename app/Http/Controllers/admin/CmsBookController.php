...
class CmsBookController extends Controller
{
    //
    ...
    {
        $data = array();
        $data['pageTitle'] = 'Cms Book Banner';
        $data['activePageName'] = 'banner';
        $data['activeSubMenu'] = 'cms_book_banner';

        $items = CmsBanner::where('type', 'book_page')->orderBy("id", "asc")->get();
        ...
        return view("admin.cms_book_banner_list", ["data" => $data]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.cms_book_banner_create", ["data" => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view("admin.cms_book_banner_edit", ["data" => $data]);
    }
