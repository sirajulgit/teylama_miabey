...
class CmsAwardHonorsController extends Controller
{
    //
    ...
    {
        $data = array();
        $data['pageTitle'] = 'Cms Award Honors Banner';
        $data['activePageName'] = 'banner';
        $data['activeSubMenu'] = 'cms_awardHonors_banner';

        $items = CmsBanner::where('type', 'awardHonors_page')->orderBy("id", "asc")->get();
        ...
        return view("admin.cms_awardHonors_banner_list", ["data" => $data]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.cms_awardHonors_banner_create", ["data" => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view("admin.cms_awardHonors_banner_edit", ["data" => $data]);
    }
