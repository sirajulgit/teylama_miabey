...
class CmsBlogPageController extends Controller
{
    //
    ...
    {
        $data = array();
        $data['pageTitle'] = 'Cms Blogs Banner';
        $data['activePageName'] = 'banner';
        $data['activeSubMenu'] = 'cms_blogs_banner';

        $items = CmsBanner::where('type', 'blogs_page')->orderBy("id", "asc")->get();
        ...
        return view("admin.cms_blogs_banner_list", ["data" => $data]);
    }
    ...
    public function create()
    {
        ...
        return view("admin.cms_blogs_banner_create", ["data" => $data]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return view("admin.cms_blogs_banner_edit", ["data" => $data]);
    }
